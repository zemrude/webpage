...
def getAuthorData(authorID="Juan.Antonio.Aguilar.Sanchez.1"):
    url =  "http://inspirehep.net/search?p=author:%s&of=recjson&ot=recid,authors[0],number_of_authors,title,doi,system_control_number,publication_info,creation_date,url,type,corporate_name[0]&rg=100" %(authorID)
